const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-5yY4t2BV.js","./preload-helper-Ct5FWWRu.js","./iframe-HP2bOzaM.css"])))=>i.map(i=>d[i]);
import{_ as z}from"./preload-helper-Ct5FWWRu.js";import{ah as c,a6 as H,ay as L,a1 as u,T as P,a7 as k}from"./iframe-5yY4t2BV.js";const U=c.lazy(async()=>z(()=>import("./iframe-5yY4t2BV.js").then(e=>e.j),__vite__mapDeps([0,1,2]),import.meta.url).then(e=>({default:e.Tooltip}))),p=60,f=3600,o=86400,y=30*o,h=365*o,Y=7*o;function Z(e){return typeof e=="number"?new Date(e<1e12?e*1e3:e):new Date(e)}function W(e,s){const a=Math.round((s.getTime()-e.getTime())/1e3);if(a<0){const t=Math.abs(a);if(t<p)return"in a few seconds";if(t<f){const n=Math.round(t/p);return`in ${n} ${n===1?"minute":"minutes"}`}if(t<o){const n=Math.round(t/f);return`in ${n} ${n===1?"hour":"hours"}`}if(t<y){const n=Math.round(t/o);return`in ${n} ${n===1?"day":"days"}`}if(t<h){const n=Math.round(t/y);return`in ${n} ${n===1?"month":"months"}`}const r=Math.round(t/h);return`in ${r} ${r===1?"year":"years"}`}if(a<10)return"just now";if(a<p)return`${a} seconds ago`;if(a<f){const t=Math.round(a/p);return`${t} ${t===1?"minute":"minutes"} ago`}if(a<o){const t=Math.round(a/f);return`${t} ${t===1?"hour":"hours"} ago`}if(a<2*o)return"yesterday";if(a<y)return`${Math.round(a/o)} days ago`;if(a<h){const t=Math.round(a/y);return`${t} ${t===1?"month":"months"} ago`}const i=Math.round(a/h);return`${i} ${i===1?"year":"years"} ago`}function l(e){return String(e).padStart(2,"0")}function X(e,s,a){switch(s){case"date":return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"short",day:"numeric"}).format(e);case"date_time":return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"2-digit",...a?{timeZoneName:"short"}:{}}).format(e);case"time":return new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit",...a?{timeZoneName:"short"}:{}}).format(e);case"system_date":{const i=e.getFullYear(),t=l(e.getMonth()+1),r=l(e.getDate());return`${i}-${t}-${r}`}case"system_date_time":{const i=e.getFullYear(),t=l(e.getMonth()+1),r=l(e.getDate()),n=l(e.getHours()),v=l(e.getMinutes()),g=l(e.getSeconds());return`${i}-${t}-${r} ${n}:${v}:${g}`}case"system_time":{const i=l(e.getHours()),t=l(e.getMinutes()),r=l(e.getSeconds());return`${i}:${t}:${r}`}}}function B(e){return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"2-digit",second:"2-digit",timeZoneName:"short"}).format(e)}function C(e){const s=Math.abs(e);return s<p?1e3:s<f?3e4:s<o?6e4:3e5}function G(e){return e!=="relative"&&e!=="auto"}function $({value:e,format:s="auto",autoThreshold:a=Y,hasTooltip:i=!0,isTimezoneShown:t=!1,isLive:r=!1,type:n="supporting",size:v,color:g="secondary",weight:M,xstyle:D,className:S,style:R,ref:q,"data-testid":I}){const x=c.useRef(null),[_,E]=c.useState(()=>new Date),d=Z(e),j=d.toISOString(),T=Math.round((_.getTime()-d.getTime())/1e3),m=s==="auto"?Math.abs(T)<=a?"relative":"date_time":s,F=m==="relative"?W(d,_):G(m)?X(d,m,t):"",b=B(d);c.useEffect(()=>{if(!r||m!=="relative")return;const N=C(T),V=setInterval(()=>{E(new Date)},N);return()=>clearInterval(V)},[r,m,T]);const A=i&&m==="relative",O=H(L("timestamp",{format:m}),{className:S,style:R}),w=u.jsx(P,{type:n,size:v,color:g,weight:M,xstyle:D,...O,children:u.jsx("time",{ref:k(q,x),dateTime:j,"aria-label":m==="relative"?b:void 0,"data-testid":I,className:"astryxt0psk2 astryxjb2p0i astryx1j61x8r astryx1qlqyl8 astryx15bjb6t astryx1heor9g astryx1pd3egz",children:F})});return A?u.jsxs(u.Fragment,{children:[w,u.jsx(c.Suspense,{fallback:null,children:u.jsx(U,{anchorRef:x,content:b,placement:"above"})})]}):w}$.displayName="Timestamp";$.__docgenInfo={description:`Displays a formatted timestamp as human-readable text.
