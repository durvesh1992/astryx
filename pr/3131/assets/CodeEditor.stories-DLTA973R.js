import{a1 as e,ah as m}from"./iframe-DT9NZtQF.js";import{C as d}from"./CodeEditor-CMuOv-UR.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-E3zx9Dc2.js";const x={title:"Lab/CodeEditor",component:d,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
