import{ah as d,a1 as a,a6 as y,af as m,ay as u}from"./iframe-DfMXn7lw.js";const f={wrapper:{k1xSpc:"astryx3nfvp2",kGNEyG:"astryx6s0dn4",kOIVth:"astryxzye2dw",kmuXW:"astryx2lah0s",$$css:!0}},x={ctrl:"⌃",alt:"⌥",shift:"⇧",enter:"↵",backspace:"⌫",escape:"Esc",tab:"⇥",up:"↑",down:"↓",left:"←",right:"→",plus:"+"};function h(e,s){return e==="mod"?s?"⌘":"Ctrl":x[e]??e.toUpperCase()}function g(){return()=>{}}function k(){return!1}function b(){if(typeof navigator>"u")return!1;const e="userAgentData"in navigator?navigator.userAgentData:null;return e&&typeof e=="object"&&"platform"in e?/mac/i.test(e.platform??""):/Mac|iPhone|iPad|iPod/.test(navigator.platform??"")}function r({keys:e,ref:s,xstyle:n,className:o,style:i,...p}){const l=d.useSyncExternalStore(g,b,k),c=e.split("+").map(t=>t.trim().toLowerCase());return a.jsx("span",{ref:s,...p,...y(u("kbd"),m(f.wrapper,n),o,i),"aria-hidden":"true",children:c.map(t=>a.jsx("kbd",{className:"astryx3nfvp2 astryx6s0dn4 astryxl56j7k astryx16asifk astryx1grt7ep astryx7a5moj astryxx3sua9 astryx17x4s8c astryxlxy82 astryx1q0q8m5 astryxw8gpjh astryxv1l7n4 astryx9ynric astryx141an7d astryx1e4wzip astryx1ltkj2j astryx87ps6o",children:h(t,l)},t))})}r.displayName="Kbd";r.__docgenInfo={description:`Displays a keyboard shortcut as styled <kbd> elements.
