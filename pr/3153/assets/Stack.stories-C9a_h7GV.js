import{af as b,ah as q,a6 as w,ay as N,a1 as e}from"./iframe-DfMXn7lw.js";import{S as r}from"./Stack-BfyqT6S-.js";import{s as P}from"./stackItem.stylex-CgqrJM4N.js";import"./preload-helper-Ct5FWWRu.js";import"./stack.stylex-BlarxY2N.js";function i({crossAlignSelf:s,size:c,as:j="div",xstyle:u,className:v,style:f,children:A,ref:z,...I}){const C=b(...P({crossAlignSelf:s,size:c}),u);return q.createElement(j,{ref:z,...w(N("stack-item",{size:c}),C,v,f),...I},A)}i.displayName="StackItem";i.__docgenInfo={description:`Stack item component for controlling individual item behavior within a stack.
