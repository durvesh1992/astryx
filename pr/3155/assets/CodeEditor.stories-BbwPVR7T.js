import{a1 as e,ah as m}from"./iframe-BLXGBSZB.js";import{C as d}from"./CodeEditor-D3jGKHRc.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-C6XHnK9b.js";const x={title:"Lab/CodeEditor",component:d,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
