import{a1 as e,B as i}from"./iframe-A0URbj9t.js";function n({icon:t,...o}){return e.jsx(i,{...o,icon:t,isIconOnly:!0})}n.displayName="IconButton";n.__docgenInfo={description:`An icon-only button — a thin wrapper around Button with \`isIconOnly\`
always set to true.
